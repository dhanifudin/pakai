...
\begin{enumerate}
  \item \textbf{Deteksi penyedia}: memeriksa jalur berikut:
    \begin{itemize}
      ...
      \item OpenAI Codex: \texttt{\textasciitilde/.pi/agent/auth.json} atau \texttt{\textasciitilde/.codex/auth.json}
    \end{itemize}
...
Pilih sumber Pi atau Codex CLI di Settings PakAI. Kredensial OAuth dibaca dari
\texttt{\textasciitilde/.pi/agent/auth.json} atau \texttt{\textasciitilde/.codex/auth.json}.
